defmodule LiveSelectBugWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveSelectBugWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveSelectBugWeb.Gettext, "errors", msg, opts)
    end
  end
